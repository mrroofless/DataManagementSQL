...
(
	...
	CONSTRAINT  R_2 FOREIGN KEY (marking) REFERENCES chips(marking)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION,
CONSTRAINT  R_3 FOREIGN KEY (title) REFERENCES produsers(title)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
)
go
...
/* ERwin Builtin 27 но€бр€ 2011 г. 12:59:21 */
...
BEGIN
  DECLARE  @errno   int,
    ...
    /* ERWIN_RELATION:CHECKSUM="0000f06d", PARENT_OWNER="", PARENT_TABLE="chips"
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="00010c09", PARENT_OWNER="", PARENT_TABLE="chips"
    CHILD_OWNER="", CHILD_TABLE="orders"
    P2C_VERB_PHRASE="R/2", C2P_VERB_PHRASE="R/2", 
    FK_CONSTRAINT="R_2", FK_COLUMNS="marking" */
  IF
...
BEGIN
  DECLARE  @errno   int,
    ...
    /* ERWIN_RELATION:CHECKSUM="0000f657", PARENT_OWNER="", PARENT_TABLE="produsers"
    CHILD_OWNER="", CHILD_TABLE="orders"
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="000105b2", PARENT_OWNER="", PARENT_TABLE="produsers"
    CHILD_OWNER="", CHILD_TABLE="orders"
    P2C_VERB_PHRASE="R/3", C2P_VERB_PHRASE="R/3", 
    FK_CONSTRAINT="R_3", FK_COLUMNS="title" */
  IF
...
BEGIN
  DECLARE  @errno   int,
    ...
    /* ERWIN_RELATION:CHECKSUM="00023fee", PARENT_OWNER="", PARENT_TABLE="chips"
    CHILD_OWNER="", CHILD_TABLE="orders"
    P2C_VERB_PHRASE="R/2", C2P_VERB_PHRASE="R/2", 
    FK_CONSTRAINT="R_2", FK_COLUMNS="marking" */
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="0002dfa6", PARENT_OWNER="", PARENT_TABLE="chips"
    CHILD_OWNER="", CHILD_TABLE="orders"
    P2C_VERB_PHRASE="R/2", C2P_VERB_PHRASE="R/2", 
    FK_CONSTRAINT="R_2", FK_COLUMNS="marking" */
  IF
